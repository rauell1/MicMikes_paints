...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: "#F8F4EF", color: "#2B2B2E", fontFamily: `"Inter", system-ui, -apple-system, Segoe UI, Roboto, sans-serif` }}>
      ...
      <main id="mm-main-scroll" className="flex-1" style={{ paddingBottom: "calc(72px + env(safe-area-inset-bottom, 0px))" }}>
      ...
      <footer className="hidden lg:block border-t mt-8" style={{ borderColor: "#e8dcc7", background: "#F8F4EF" }}>
        <div className="max-w-7xl mx-auto px-8 py-8 flex flex-wrap items-center justify-between gap-4 text-[13px]" style={{ color: "#7b7468" }}>
          <div className="flex items-center gap-2">
            <span className="font-display text-[15px]" style={{ color: "#2B2B2E" }}>MicMikes Paints</span>
            <span>·</span><span>Keekorok Edition</span><span>·</span><span>Nairobi, Kenya</span>
          </div>
          <div className="flex items-center gap-5">
            <a href="https://wa.me/254712345678" target="_blank" rel="noopener noreferrer" className="hover:opacity-70 transition-opacity flex items-center gap-1.5">
...
function ScrollToTop() {
  ...
  return (
    <button
      ...
      className="fixed z-[63] right-4 flex items-center justify-center rounded-full mm-shadow transition-all hover:scale-105"
